...
Gem::Specification.new do |s|
  ...
  s.files = ["MIT-LICENSE", "README.md", "Rakefile", "app/assets/javascripts/active_admin", "app/assets/javascripts/active_admin/sortable.js.coffee", "app/assets/stylesheets/active_admin", "app/assets/stylesheets/active_admin/sortable.css.sass", "lib/active_admin", "lib/active_admin/sortable", "lib/active_admin/sortable.rb", "lib/active_admin/sortable/controller_actions.rb", "lib/active_admin/sortable/engine.rb", "lib/active_admin/sortable/version.rb", "lib/active_admin/views", "lib/active_admin/views/index_as_block_decorator.rb", "lib/active_admin/views/index_as_sortable.rb", "lib/activeadmin-sortable-tree.rb", "lib/tasks/activeadmin-tree_tasks.rake"]
